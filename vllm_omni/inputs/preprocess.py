...
try:
    ...
    from vllm.inputs import EmbedsInputs as EmbedsInput
    from vllm.inputs import SingletonInputs as SingletonInput
    from vllm.inputs.data import MultiModalInputs as MultiModalInput
